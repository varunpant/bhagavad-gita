...
Both derive from `srimad.csv`. The app additionally uses `enriched.sqlite`,
generated by `tools/enrich.py` (see Tooling below).
...
| `make_og_images.py` | `content/` | `themes/book/static/og/*.jpg` |
