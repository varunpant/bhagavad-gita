...
// The Devanagari numerals used to live here. They moved to
// `Core/Utilities/Int+Digits.swift` so the widget extension can use them: this
// file imports GRDB, and nothing the extension compiles may.
