...
nonisolated enum Brand {
    private static let yellow = Color(red: 0xFF / 255, green: 0xC9 / 255, blue: 0x3C / 255)
    private static let orange = Color(red: 0xFF / 255, green: 0x7A / 255, blue: 0x18 / 255)
    private static let pink = Color(red: 0xFF / 255, green: 0x2D / 255, blue: 0x78 / 255)
