...
struct GitaApp: App {
    ...
    /// What the reader has done towards marking the verse in front of them —
    /// written by `ReadingTrackerModifier`, drawn by the header's meter.
    @State private var dwell = ReadingDwell()
